...
from flow_klein.data.benchmarks_standard import is_benchmark_dataset, load_benchmark_splits
import dgl
...
def list_graph_loader(graph_type, _max_list_size=None, return_labels=False,
  ...
  if graph_type=="IMDBBINARY":
      ...
      raise ValueError("Unsupported dataset for standard configuration: " + str(graph_type))
